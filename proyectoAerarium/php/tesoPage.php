...
<body class="body2">
    ...
    <div class="total">
            ...
            <br>
            <h1 class="display-4 ">Hola Tesorero</h1>
            <br>
            <h1 class="display-4 "><?php echo "Tu documento es: ".$_SESSION['documento']?></h1>
            <br>
            <h1 class="com"> COMBUSCOL</h1>
            <br>
            <a class="btn btn-warning" style="font-size: 25px;" font href="pagos.html">Descúbrelo</a>
            </div>
