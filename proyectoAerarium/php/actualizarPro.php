...
<div class="navbar-right">
  ...
  <div class="contReg margen">
    ...
    <h2 class="textNorm centrarBtn">Actualizar datos proveedor</h2>
    <br>
  
    <h1 class="display-4 "><?php echo "El valor de documentoPro es: " . $docPro;?></h1>
    <?php
    ...
    if ($resultados) {
     while($consulta = mysqli_fetch_array($resultados)) {
      ...
      echo"Hola " .$consulta['nombresProveedor']; echo " ". $consulta['apellidosProveedor']."<br>";?>
    ...
    ?>
      ...
      <form action="actualizarPro.php" target="_self" method="POST" enctype="multipart/form-data">
          ...
          <input class="btn btn-dark  margenBtn" name="btnCon" type="submit" value="Consultar">

          <input class="btn btn-success  margenBtn" name="btnAct" type="submit" value="Actualizar">

          <input class="btn btn-danger  margenBtn" name="btnEli" type="submit" value="Eliminar">
          </div>
         <br>
